...
def call_to_adventure(player):
    ...
    """
    print(f"""
    A {Fore.LIGHTCYAN_EX}{Style.BRIGHT}Mysterious Stranger{Style.RESET_ALL} approaches you as you rest by the fire.
    {Fore.LIGHTCYAN_EX}{Style.BRIGHT}"{Style.RESET_ALL}{Fore.LIGHTBLUE_EX}{Style.BRIGHT}{player.name}{Style.RESET_ALL}{Fore.LIGHTCYAN_EX}{Style.BRIGHT}, I have been watching you. You seem like someone
    destined for great things. 
    
    It is prophecied that a brave,{Style.RESET_ALL} {Fore.LIGHTBLUE_EX}{Style.BRIGHT}{player.height}{Style.RESET_ALL}, {Fore.LIGHTBLUE_EX}{Style.BRIGHT}{player.sex}{Style.RESET_ALL} {Fore.LIGHTCYAN_EX}{Style.BRIGHT}like
    you will some day make it to the{Style.RESET_ALL} {Fore.RED}{Style.BRIGHT}Beast Lord{Style.RESET_ALL}{Fore.LIGHTCYAN_EX}{Style.BRIGHT}'s{Style.RESET_ALL} {Fore.CYAN}{Style.BRIGHT}Castle{Style.RESET_ALL} 
    {Fore.LIGHTCYAN_EX}{Style.BRIGHT}and end his tyrannous reign. 
    
    I can guide you to a{Style.RESET_ALL} {Fore.CYAN}{Style.BRIGHT}Tavern{Style.RESET_ALL} {Fore.LIGHTCYAN_EX}{Style.BRIGHT}frequented by smugglers and
    mercenaries who know ways of entering{Style.RESET_ALL} {Fore.CYAN}{Style.BRIGHT}The Castle{Style.RESET_ALL}{Fore.LIGHTCYAN_EX}{Style.BRIGHT}.
    
    However, you first must make the choice. Will you answer{Style.RESET_ALL} {Fore.CYAN}{Style.BRIGHT}The Call 
    To Adventure{Style.RESET_ALL}{Fore.LIGHTCYAN_EX}{Style.BRIGHT}, claim untold riches, and liberate the people of{Style.RESET_ALL} 
    {Fore.MAGENTA}{Style.BRIGHT}Pythonia{Style.RESET_ALL} {Fore.LIGHTCYAN_EX}{Style.BRIGHT}or will you sit here by the fire and live a quiet life?"
    """)
...
def initial_dialogue_tavern(player):
    print(f"""The {Fore.LIGHTCYAN_EX}{Style.BRIGHT}Mysterious Stranger{Style.RESET_ALL} leads you to a murky {Fore.CYAN}{Style.BRIGHT}Tavern{Style.RESET_ALL}.\n
    ...
    {Fore.LIGHTCYAN_EX}{Style.BRIGHT}Mysterious Stranger{Style.RESET_ALL}.\n""")
    ...
    print(f"\nThe {Fore.LIGHTCYAN_EX}{Style.BRIGHT}Mysterious Stranger{Style.RESET_ALL} bows, wishes you luck, and takes his leave.\n")
